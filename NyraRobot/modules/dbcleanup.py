...
import NyraRobot.modules.sql.global_bans_sql as gban_sql
import NyraRobot.modules.sql.users_sql as user_sql
from NyraRobot import DEV_USERS, OWNER_ID, dispatcher

...
# from NyraRobot.modules.sql import warns_sql as warnssql
import NyraRobot.modules.sql.blacklist_sql as blacklistsql

# from NyraRobot.modules.sql import cust_filters_sql as filtersql
# import NyraRobot.modules.sql.welcome_sql as welcsql
import NyraRobot.modules.sql.locks_sql as locksql
import NyraRobot.modules.sql.notes_sql as sql

# from NyraRobot.modules.rules import get_rules
import NyraRobot.modules.sql.rules_sql as rulessql
from NyraRobot import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from NyraRobot.__main__ import DATA_IMPORT
from NyraRobot.modules.connection import connected
from NyraRobot.modules.helper_funcs.alternate import typing_action
from NyraRobot.modules.helper_funcs.chat_status import user_admin
from NyraRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("NyraRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("NyraRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `NyraRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("NyraRobot{}.backup".format(chat_id))  # Cleaning file

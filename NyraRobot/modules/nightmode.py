...
from NyraRobot import BOT_NAME
from NyraRobot import telethn as tbot
from NyraRobot.events import register
from NyraRobot.modules.sql.night_mode_sql import (
    add_nightmode,
    get_all_chat_id,
    is_nightmode_indb,
    rmnightmode,
